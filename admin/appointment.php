    ...
    <div class="flex h-screen">
        ...
        <div class="w-1/5 bg-white border-r border-gray-200 shadow-sm">
            ...
            <nav class="mt-6">
                ...
                <a href="appointment.php" class="block py-2 px-4 text-purple-600 bg-purple-50">Appointment</a>
        ...
        <div class="w-4/5 p-6">
            <div class="flex justify-between items-center mb-6">
                <a href="appointment.php" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition duration-300 flex items-center">
                    <span>Back</span>
                </a>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <p class="text-xl font-bold text-gray-800 mb-4">All Appointments (<?php echo $list110->num_rows; ?>)</p>
                <div class="overflow-auto">
                    <table class="w-full">
                        <thead>
                            <tr class="bg-purple-50">
                                <th class="px-4 py-2 text-left text-sm text-purple-600">Patient Name</th>
                                <th class="px-4 py-2 text-left text-sm text-purple-600">Appointment Number</th>
                                ...
                                <th class="px-4 py-2 text-left text-sm text-purple-600">Session Date & Time</th>
                                <th class="px-4 py-2 text-left text-sm text-purple-600">Appointment Date</th>
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows == 0) {
                                echo '<tr><td colspan="7" class="text-center text-gray-500 py-4">No appointments found.</td></tr>';
                            } else {
                                for ($x = 0; $x < $result->num_rows; $x++) {
                                    ...
                                    echo '<tr class="border-b border-gray-200">
                                        <td class="px-4 py-2">' . substr($pname, 0, 25) . '</td>
                                        <td class="px-4 py-2 text-center text-purple-600">' . $apponum . '</td>
                                        <td class="px-4 py-2">' . substr($docname, 0, 25) . '</td>
                                        <td class="px-4 py-2">' . substr($title, 0, 15) . '</td>
                                        <td class="px-4 py-2 text-center">' . substr($scheduledate, 0, 10) . ' <br>' . substr($scheduletime, 0, 5) . '</td>
                                        <td class="px-4 py-2 text-center">' . $appodate . '</td>
                                        <td class="px-4 py-2">
                                            <div class="flex space-x-2">
                                                <a href="?action=drop&id=' . $appoid . '&name=' . $pname . '&session=' . $title . '&apponum=' . $apponum . '" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition duration-300">Cancel</a>
                                            </div>
                                        </td>
                                    </tr>';
                                }
                ...
                <div class="bg-white rounded-lg p-6 w-1/3">
                    <center>
                        ...
                        <div class="flex justify-center space-x-4">
                            <a href="delete-appointment.php?id=' . $id . '" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition duration-300">Yes</a>
                            <a href="appointment.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-300">No</a>
                        </div>
                    </center>
                </div>
            </div>';
