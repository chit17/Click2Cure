    ...
    <div class="flex h-screen">
        ...
        <div class="w-4/5 p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="?action=add&id=none&error=0" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition duration-300 flex items-center">
                    <span>Add New</span>
                </a>
            </div>
            ...
            <div id="popup1" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <div class="bg-white rounded-lg p-6 w-1/3">
                    <center>
                        ...
                        <div class="text-gray-600 mb-4">You want to delete this record<br>(' . substr($nameget, 0, 40) . ').</div>
                        <div class="flex justify-center space-x-4">
                            <a href="delete-doctor.php?id=' . $id . '" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition duration-300">Yes</a>
                            <a href="doctors.php" class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-300">No</a>
                        </div>
                    </center>
                </div>
            </div>';
            ...
            <div id="popup1" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <div class="bg-white rounded-lg p-6 w-1/3">
                    <center>
                        ...
                        <a href="doctors.php" class="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition duration-300 mt-4">OK</a>
                    </center>
                </div>
            </div>';
        }
